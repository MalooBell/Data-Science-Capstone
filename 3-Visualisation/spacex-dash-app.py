...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        # For 'ALL', create a pie chart showing success counts per site
        # We filter for successful launches (class == 1) and then group by site
        successful_launches_df = spacex_df[spacex_df['class'] == 1]
        fig = px.pie(successful_launches_df, names='Launch Site', 
                     title='Total Successful Launches by Site')
    else:
        # For a specific site, show success (1) vs. failure (0) counts
